...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tenantContract->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tenantContract->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="tenantContracts form content">
            ...
            <fieldset>
                <legend><?= __('Edit Tenant Contract') ?></legend>
                <?php
