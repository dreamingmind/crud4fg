...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $shippingAccount->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $shippingAccount->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="shippingAccounts form content">
            ...
            <fieldset>
                <legend><?= __('Edit Shipping Account') ?></legend>
                <?php
