...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $legacyCustomer->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $legacyCustomer->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="legacyCustomers form content">
            ...
            <fieldset>
                <legend><?= __('Edit Legacy Customer') ?></legend>
                <?php
