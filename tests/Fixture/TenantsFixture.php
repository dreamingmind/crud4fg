...
class TenantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'char', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'warehouse_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'customer_code' => ['type' => 'char', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'token' => ['type' => 'char', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'name' => ['type' => 'index', 'columns' => ['name'], 'length' => ['name' => '20']],
            'warehouse_id' => ['type' => 'index', 'columns' => ['warehouse_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'tenants_ibfk_1' => ['type' => 'foreign', 'columns' => ['warehouse_id'], 'references' => ['warehouses', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
