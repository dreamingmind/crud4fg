...
'foreignKey' => 'old_item_id',
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->requirePresence('on_order_quantity', 'create')
            ->notEmptyString('on_order_quantity');

        $validator
            ->integer('on_replenishment_quantity')
            ->requirePresence('on_replenishment_quantity', 'create')
            ->notEmptyString('on_replenishment_quantity');

        $validator
            ->integer('available_quantity')
            ->requirePresence('available_quantity', 'create')
            ->notEmptyString('available_quantity');
